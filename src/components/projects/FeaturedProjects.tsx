  ...
  const projects = [
    {
      ...
      description: "Developed a multi-protocol smart home and industrial IoT hub that enables seamless connectivity across devices using various wireless technologies.",
      features: [
    ...
    },
    {
      ...
      description: "Built a comprehensive ERP system for streamlining business operations, with modules for CRM, HRM, and business process automation.",
      features: [
    ...
    },
    {
      ...
      description: "Developed high-performance APIs for real-time financial data processing with enhanced security and optimization.",
      features: [
    ...
    },
    {
      ...
      description: "Designed and implemented communication protocols for smart hardware devices using various wireless technologies.",
      features: [
  ...
  return (
    <section className="py-12 overflow-hidden">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-8 text-center animate-fade-in text-gradient">
          Featured Projects
        </h2>
