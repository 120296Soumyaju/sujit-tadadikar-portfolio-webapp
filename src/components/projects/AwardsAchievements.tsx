...
const AwardsAchievements = () => {
  const achievements = [
    {
      title:
        "🏆 Participated in 12th Inter-University Avishkar Research Convention 2017-2018",
      project:
        "📱 SOS: Signal of Stress / Save Our Soul - Your Personal Safety App",
      level: "UG",
    ...
    {
      title:
        "🏆 Participated in 12th Inter-University Avishkar Research Convention 2018-2019",
    ...
    {
      title:
        "🏆 Participated in 13th Inter-University Avishkar Research Convention 2018-2019",
