          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-gray-600 mt-4 max-w-lg">
                Experienced Backend Python Engineer with expertise in API
                development, Flask, database management, and IoT integration.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <p className="text-gray-700 mb-4">
              Experienced Backend Python Engineer with expertise in API
              development, Flask, database management, and IoT integration.
              Skilled in building scalable applications and optimizing backend
              systems. Holding an MCA, currently expanding skills in DevOps and
              Cloud Engineering to enhance deployment and infrastructure
              management.
            </p>
            <p className="text-gray-700 mb-4">
              Results-driven API Integration Engineer with 5+ years of
              experience in REST, OAuth2, JWT authentication, and financial data
              formats, with hands-on skills in Python and FastAPI. Strong
              background in troubleshooting, performance optimization, and PCI
              DSS compliance.
            </p>
            <p className="text-gray-700">
              Additionally, experienced in documentation, customer interactions,
              and technical support within the shipping industry, ensuring
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Arduino Uno, Raspberry Pi, NXP i.MX8
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
